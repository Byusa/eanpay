...
import PayConnectHome from '../assets/images/PayConnectHome.svg';
import HomeEanpayMoneyTransfer from '../assets/images/HomeEanpayMoneyTransfer.svg';
import slider_1 from '../assets/tempImages/bg/image-1.jpg';
class HomeMiddle1 extends Component {
    render() {
        return (
            // Slideshow
            // =============================================
