    ...
    handleOnPressContinue = async (e) => {
        ...
        if (rate) {
            ...
            if(this.isEqual(today,date)) 
            {
                ...
                //
                db.collection("rates").doc(rate.rateId).update({
                    rateAmount: rateconv,
                    rateDate: new Date(),
                })
                    .then(function () {
            ...
            db.collection("rates").doc(ref.id).set(rateObject)
                .then(function () {
            ...
            <div className="row">
                ...
                <div className="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
                    ...
                    <div className="form-group">
                        ...
                        <div>
                            <select id="youSendCurrency country" data-style="custom-select bg-transparent border-0" data-container="body" data-live-search="true" name="country" className="selectpicker form-control bg-transparent" onChange={(event) => this.setState({ country: countries[event.target.value] })}>
...
const mapDispatchStateToProps = (dispatch) => ({
    addCountry: (country, rate, recieverCurrency) => dispatch(addCountry(country, rate, recieverCurrency))
})
...
export default connect(
    mapStateToProps,
    mapDispatchStateToProps)(withRouter(NewTransA));