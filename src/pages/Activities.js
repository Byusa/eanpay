                    ...
                    <div class="row"> 
                      ...
                      <aside class="col-lg-3"> 
                          ...
                          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
                              ...
                              <p class="mb-2"><Link to="/AddProfile" class="text-5 text-light" data-toggle="tooltip" title="Edit Profile"><i class="fas fa-edit"></i></Link></p>
                          </div>
                          {/* <!-- Profile Details End --> 
                        ...
                        */}
                          ...
                          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
                              ...
                              <Link to="SignUp" class="btn btn-primary btn-block">Chate with Us</Link> 
                          </div>
                          {/* <!-- Need Help? End -->  */}
                      ...
                      <div class="col-lg-9"> 
                        ...
                        <div class="bg-white shadow-sm rounded py-4 mb-4">
                          ...
                          <div class="transaction-list">
                            <div class="transaction-item px-4 py-3" data-toggle="modal" data-target="#transaction-detail">
                              <div class="row align-items-center flex-row">
                                <div class="col-2 col-sm-1 text-center"> <span class="d-block text-4 font-weight-300">16</span> <span class="d-block text-1 font-weight-300 text-uppercase">June</span> </div>
                                <div class="col col-sm-7"> <span class="d-block text-4">Kevine Kagirimundu</span> <span class="text-muted">MTN Mobile Money Transfer</span> </div>
                                ...
                                <div class="col-3 col-sm-2 text-right text-4"> <span class="text-nowrap">- $200.00</span> <span class="text-2 text-uppercase">(CAD)</span> </div>
                              </div>
                            </div>
                          </div>
                                  ...
                                  <div class="row no-gutters">
                                    <div class="col-sm-5 d-flex justify-content-center bg-primary rounded-left py-4">
                                      <div class="my-auto text-center">
                                        ...
                                        <h3 class="text-4 text-white font-weight-400 my-3">Mobile Money Transfer</h3>
                                        <div class="text-8 font-weight-500 text-white my-4">$200.00</div>
                                        <p class="text-white">15 June 2020</p>
                                      </div>
                                    </div>
                                    <div class="col-sm-7">
                                      ...
                                      <div class="px-3">
                                        <ul class="list-unstyled">
                                          <li class="mb-2">Payment Amount <span class="float-right text-3">$200.00</span></li>
                                          <li class="mb-2">Fee <span class="float-right text-3">-$10</span></li>
                                        </ul>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <div class="text-center mt-4"><Link to="/Activities" class="btn-link text-3">View all<i class="fas fa-chevron-right text-2 ml-2"></i></Link></div>
                        </div>
                      </div>
                    </div>
                  </div>
